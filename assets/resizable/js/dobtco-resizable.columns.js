        ...
        var ResizableColumns = (function () {
            ...
            _createClass(ResizableColumns, [{
                ...
                value: function refreshHeaders() {
                    ...
                    // Ensure data-resizable-keys
                    if(this.$table.data(_constants.DATA_COLUMNS_ID) === undefined) {
                        this.$table.data(_constants.DATA_COLUMNS_ID, this.$table.parents('.grid-view').prop('id'));
                    }
                    this.$tableHeaders.each(function(i, el) {
                        var $el = $(el);
                        if($el.data(_constants.DATA_COLUMN_ID) === undefined) {
                            $el.data(_constants.DATA_COLUMN_ID, 'rs-col-' + i);
                        }
                    });
